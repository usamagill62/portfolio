  ...
  return (
    <div id="about" className="row">
      <div className="col-12">
        <p>
          Back in 2018, I decided to try my hand at creating websites and
          ...
          ,{" "}
          <span>
            <a href="https://kudoway.com/">
              a in-person language interpretation company
            </a>
          </span>
          ,{" "}
          <span>
            <a href="https://app.goboon.co/signin">
      ...
      <div className="col-12">
        <p className="">
          ...
          activities such as <span>sports</span> and <span>tourism</span>. I
          find joy in exploring new destinations, indulging in different sports,
